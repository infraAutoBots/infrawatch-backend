...
OIDS = {
    ...
    "cpu": [
        ...
        "1.3.6.1.4.1.2021.11.50.0",  # Linux CPU system (corrigido typo)
...
async def snmp_get(ip: str, version: str, community: str, user: str, auth_key: str, priv_key: str, 
                  port: int, key: str, timeout: float = 10.0, retries: int = 2) -> Optional[str]:
...
# ----------------------------------------
async def get_snmp_info(ips: List[str], version: str = "2c", community: str = "public",
                       user: str = "", auth_key: str = "", priv_key: str = "",
                       port: int = 161, timeout: float = 10.0, retries: int = 2) -> Dict[str, Dict[str, Any]]:
    """
